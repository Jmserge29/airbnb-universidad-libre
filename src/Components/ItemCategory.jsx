...
function ItemCategory({category}) {
  return (
    <>
    <div className='group rounded-3xl  hover:bg-slate-50 hover:shadow-md cursor-pointer px-2'>
        <div className=' p-2 flex justify-center mt-1 content-center px-2 hover:scale-110 transition duration-150 ease-in-out'>
            <div className=" col-span-1 pl-2 pr-1 font-semibold">{category.name}</div>
